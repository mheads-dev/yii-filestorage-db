...
/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'YourStrong!Passw0rd' -C -Q "
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'mhfs-test')
  CREATE DATABASE [mhfs-test];
"

/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'YourStrong!Passw0rd' -C -d mhfs-test -Q "
